...
def setup():
    ...
    if not os.path.isdir('bitcoin'):
        subprocess.check_call(['git', 'clone', 'https://github.com/emrals/EMRALS.git'])
...
def build():
    ...
    if args.linux:
        ...
        subprocess.check_call('mv build/out/emrals-*.tar.gz build/out/src/emrals-*.tar.gz ../bitcoin-binaries/'+args.version, shell=True)
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/emrals-*.zip build/out/emrals-*.exe build/out/src/emrals-*.tar.gz ../bitcoin-binaries/'+args.version, shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/emrals-*.tar.gz build/out/emrals-*.dmg build/out/src/emrals-*.tar.gz ../bitcoin-binaries/'+args.version, shell=True)

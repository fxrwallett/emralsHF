# Bootstrappable EMRALS Core Builds

This directory contains the files necessary to perform bootstrappable EMRALS
Core builds.
...
- 24GB of free disk space on the partition that the EMRALS Core git repository
  resides in
...
For a EMRALS Core depends development environment, simply invoke
...
From the top of a clean EMRALS Core repository:
...
To use dongcarl's substitute server for EMRALS Core builds after having

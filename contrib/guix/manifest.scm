...
(define* (make-emrals-cross-toolchain target
                                  #:key
...
desirable for building EMRALS Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-emrals-cross-toolchain "i686-linux-gnu")
       (make-emrals-cross-toolchain "x86_64-linux-gnu")
       (make-emrals-cross-toolchain "aarch64-linux-gnu")
       (make-emrals-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-emrals-cross-toolchain "riscv64-linux-gnu"

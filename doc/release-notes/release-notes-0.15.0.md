...
- #10228 `27faa6c` build: regenerate emrals-config.h as necessary (theuni)
...
- #10359 `329fc1d` [tests] functional tests should call EMRALSTestFramework start/stop node methods (jnewbery)
...
- #10556 `65cc7aa` Move stop/start functions from utils.py into EMRALSTestFramework (jnewbery)

...
- #11771 `2dbc4a4` Change invalidtxrequest to use EMRALSTestFramework (jnewbery)
...
- #11772 `0630974` Change invalidblockrequest to use EMRALSTestFramework (jnewbery)
...
- #11773 `f0f9732` Change `feature_block.py` to use EMRALSTestFramework (jnewbery)
- #12839 `40f4baf` Remove travis checkout depth (laanwj)
- #11817 `2a09a78` Change `feature_csv_activation.py` to use EMRALSTestFramework (jnewbery)
...
- #12856 `27278df` Add Metaclass for EMRALSTestFramework (WillAyd)

...
#ifndef EMRALS_COINS_H
#define EMRALS_COINS_H
...
public:
    ...
    /**
     * Amount of emralss coming in to a transaction
 ...
 * between emralsd, and emrals-qt and non-server tools.
 *

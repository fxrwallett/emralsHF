...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " emrals-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  emrals-tx [options] <hex-tx> [commands]  Update hex-encoded emrals transaction\n" +
            "or:     emrals-tx [options] -create [commands]   Create hex-encoded emrals transaction\n" +
            "\n";

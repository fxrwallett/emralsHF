...
#ifndef EMRALS_INTERFACES_CHAIN_H
#define EMRALS_INTERFACES_CHAIN_H
...
//! internal workings of the emrals node, and not being very convenient to use.
...
#endif // EMRALS_INTERFACES_CHAIN_H

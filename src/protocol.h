...
#ifndef EMRALS_PROTOCOL_H
#define EMRALS_PROTOCOL_H
...
/**
 * EMRALS protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all EMRALS Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_GETUTXO means the node is capable of responding to the getutxo protocol request.
    // EMRALS Core does not support this but a patch set called EMRALS XT does.
    ...
    // emrals-development mailing list. Remember that service bits are just

This directory contains the EMRALSQT graphical user interface (GUI). It uses the cross-platform framework [Qt](https://www1.qt.io/developers/).
...
Represents the main window of the EMRALS UI.
...
Used to process BIP21 and BIP70 (see https://github.com/bitcoin/bitcoin/pull/11622) payment URI / requests. Also handles URI based application switching (e.g. when following a emrals:... link from a browser).
...
* `emralsstrings.cpp`: automatically generated
...
10. Start debugging with Qt Creator (you might need to the executable to "emrals-qt" under "Run", which is where you can also add command line arguments)

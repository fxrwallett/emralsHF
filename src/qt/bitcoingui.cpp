...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/emrals"), tr("&About %1").arg(PACKAGE_NAME), this);
    ...
    toggleHideAction = new QAction(platformStyle->TextColorIcon(":/icons/emrals"), tr("&Show / Hide"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible EMRALS command-line options").arg(PACKAGE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to EMRALS network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {

...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated emrals to."},
            ...
            + "If you are running the emrals core wallet, you can get a new address to send the newly generated emrals to with:\n"
...
// NOTE: Unlike wallet RPC (which use EMRALS values), mining RPCs follow GBT (BIP 22) in using satoshi amounts

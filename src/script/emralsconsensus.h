...
#ifndef EMRALS_SCRIPT_EMRALSCONSENSUS_H
#define EMRALS_SCRIPT_EMRALSCONSENSUS_H
...
#include <config/emrals-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBEMRALSCONSENSUS)
...
#define EMRALSCONSENSUS_API_VER 1
...
#endif // EMRALS_SCRIPT_EMRALSCONSENSUS_H

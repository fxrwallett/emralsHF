...
#ifndef EMRALS_SCRIPT_STANDARD_H
#define EMRALS_SCRIPT_STANDARD_H
...
/**
 * Generate a EMRALS scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // EMRALS_SCRIPT_STANDARD_H

...
#ifndef EMRALS_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define EMRALS_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif // EMRALS_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H

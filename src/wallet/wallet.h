...
#ifndef EMRALS_WALLET_WALLET_H
#define EMRALS_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! emrals from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The EMRALS Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this emrals node, and set to 0 for transactions that were created

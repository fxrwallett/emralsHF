...
- Use a module-level docstring to describe what the test is testing, and how it
  is testing it.
- When subclassing the EMRALSTestFramwork, place overrides for the
...
with the emralsd(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a emralsd.  `P2PInterface`
contains the higher level logic for processing P2P payloads and connecting to
the EMRALS Core node application logic. For custom behaviour, subclass the
...
Basic code to support P2P connectivity to a emralsd.

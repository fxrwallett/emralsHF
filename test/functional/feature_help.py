...
"""Verify that starting emrals with -h works as expected."""

from test_framework.test_framework import EMRALSTestFramework
from test_framework.util import assert_equal

class HelpTest(EMRALSTestFramework):
    ...
    def run_test(self):
        self.log.info("Start emrals with -h for help text")
        ...
        self.log.info("Start emrals with -version for version information")
        ...
        self.log.info("Start emralsd with -fakearg to make sure it does not start")

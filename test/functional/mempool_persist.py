...
By default, emralsd will dump mempool on shutdown and
...
class MempoolPersistTest(EMRALSTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent emralsd from writing mempool.dat to disk. Verify that `savemempool` fails")

...
# TestP2PConn: A peer we use to send messages to emralsd, and store responses.
...
class CompactBlocksTest(EMRALSTestFramework):
    ...
    # This test actually causes emralsd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that emralsd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for emralsd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # emralsd will not send blocktxn responses for blocks whose height is
